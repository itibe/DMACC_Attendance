...
public class TakeAttendanceGUI extends JFrame {
		...
		private String iconName = "C:\\Users\\Ian Tibe\\DataStructure_FinalProject\\src\\dmacc_icon.png"; //path to icon file
		...
		public void generateWindow()
		{
			...
			classTextArea.setText("Test class");
		...
		class exitAttendanceButton implements ActionListener{
			...
			@Override
			public void actionPerformed(ActionEvent arg0) {
				System.out.println("Exit attendance button pressed");
