...
public class tester {
	...
	public static void main(String[] args) throws IOException {
		...
		//SimplePasswordGUI test11 = new SimplePasswordGUI();
		//test11.generatewindow();
		//AddClass test14 = new AddClass();
		//test14.addclass("second class");
		//ErrorGUI test = new ErrorGUI();
		//test.generateMessage(1);
		//AddStudent test15 = new AddStudent();
		//test15.addstudent("Michelle ruse", "second class", "899999999");
		//test15.addstudent("Ian Tibe", "second class", "556265486");
		//System.out.println(test15.getstudentname("556265486", "second classs"));
		//TakeAttendance test16 = new TakeAttendance();
